...
export const POSTER_LIST_FILTERS = Object.freeze({
...
export const GREETING_POSTER_FILTERS = [
  POSTER_LIST_FILTERS.status.name,
  POSTER_LIST_FILTERS.posterType.name,
  POSTER_LIST_FILTERS.languages.name,
  POSTER_LIST_FILTERS.publishedAt.name,
  POSTER_LIST_FILTERS.createdAt.name,
  POSTER_LIST_FILTERS.category.name,
];

export const POLITICAL_POSTER_FILTERS = [
  POSTER_LIST_FILTERS.status.name,
  POSTER_LIST_FILTERS.posterType.name,
  POSTER_LIST_FILTERS.languages.name,
  POSTER_LIST_FILTERS.publishedAt.name,
  POSTER_LIST_FILTERS.createdAt.name,
  POSTER_LIST_FILTERS.party.name,
  POSTER_LIST_FILTERS.partyState.name,
];
